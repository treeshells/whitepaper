...
4、高带宽需求意味着从堆在很多超速处理单元、分享同样内存的加速在每个单独的单元给出很少的利益，通过阻止专用芯片共享内存的方式，降低矿机的作用，达到反AIISIC去中心化目的。
...
瓦贝公链预制了2000枚瓦贝，主链正式上线前将有200万枚瓦贝被挖出；上线后，每年都将有约18.75万枚，每年密钥丢失、密码忘记、手机丢失、被盗等各种原因导致的损失初步估算在总量的0.85%左右，与年产量持平，这就使得瓦贝的整体数量始终保持在2200万枚左右。
