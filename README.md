...
首先要申明的是，双公链之一，汉源链虽具有公链的全部特征，但其构建在中国合法的框架下，将不公开发行代币，其数字货币将做为普通积分用途，用于技术激励、交易上传、消费激励。而幸福链构建在新加坡合法的法律框架之上，将在全球公共发行数字货币及其价值理念的推广。
